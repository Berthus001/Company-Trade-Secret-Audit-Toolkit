...
const DEFAULT_QUESTIONS = [
  // Access Control Questions
  {
    ...
    options: [
      { label: 'Very Good', value: 3, description: 'Comprehensive RBAC with regular reviews, principle of least privilege strictly enforced' },
      { label: 'Good', value: 2, description: 'RBAC implemented with occasional reviews, most users follow least privilege' },
  ...
  },
  {
    ...
    options: [
      { label: 'Very Good', value: 3, description: 'MFA required for all systems accessing trade secrets, hardware tokens available' },
      { label: 'Good', value: 2, description: 'MFA required for most sensitive systems, app-based authentication' },
  ...
  },
  {
    ...
    options: [
      { label: 'Very Good', value: 3, description: 'Real-time monitoring with automated alerts, comprehensive audit trails' },
      { label: 'Good', value: 2, description: 'Regular log reviews, alerts for suspicious activity' },
  ...
  },
  {
    ...
    options: [
      { label: 'Very Good', value: 3, description: 'Automated access revocation within hours, comprehensive offboarding checklist' },
      { label: 'Good', value: 2, description: 'Access removed within 24 hours, documented process' },
  ...
  },
  {
    ...
    options: [
      { label: 'Very Good', value: 3, description: 'Strict vetting, limited access scope, regular audits, NDAs enforced' },
      { label: 'Good', value: 2, description: 'NDAs required, access limited to necessary systems' },
  ...
  // Data Encryption Questions
  {
    ...
    options: [
      { label: 'Very Good', value: 3, description: 'All trade secret data encrypted with AES-256 or equivalent, regular key rotation' },
      { label: 'Good', value: 2, description: 'Most sensitive data encrypted, key management in place' },
  ...
  },
  {
    ...
    options: [
      { label: 'Very Good', value: 3, description: 'TLS 1.3 everywhere, certificate pinning, no exceptions' },
      { label: 'Good', value: 2, description: 'TLS 1.2+ for all external communications' },
  ...
  },
  {
    ...
    options: [
      { label: 'Very Good', value: 3, description: 'HSM-backed key management, automated rotation, strict access controls' },
      { label: 'Good', value: 2, description: 'Dedicated key management solution, documented procedures' },
  ...
  },
  {
    ...
    options: [
      { label: 'Very Good', value: 3, description: 'Full disk encryption on all devices, centrally managed' },
      { label: 'Good', value: 2, description: 'Encryption required and verified on most devices' },
  ...
  },
  {
    ...
    options: [
      { label: 'Very Good', value: 3, description: 'All backups encrypted, keys stored separately, tested recovery' },
      { label: 'Good', value: 2, description: 'Backups encrypted with documented key storage' },
  ...
  // Employee Policies Questions
  {
    ...
    options: [
      { label: 'Very Good', value: 3, description: 'Comprehensive NDAs reviewed by legal, covering all trade secret scenarios, regularly updated' },
      { label: 'Good', value: 2, description: 'Standard NDAs for all employees with specific trade secret clauses' },
  ...
  },
  {
    ...
    options: [
      { label: 'Very Good', value: 3, description: 'Annual mandatory training with testing, role-specific modules, phishing simulations' },
      { label: 'Good', value: 2, description: 'Annual training for all employees with acknowledgment' },
  ...
  },
  {
    ...
    options: [
      { label: 'Very Good', value: 3, description: 'Clear classification system, handling procedures for each level, regular audits' },
      { label: 'Good', value: 2, description: 'Classification system in place with documented procedures' },
  ...
  },
  {
    ...
    options: [
      { label: 'Very Good', value: 3, description: 'Comprehensive checklist, exit interviews, device return verification, reminder of obligations' },
      { label: 'Good', value: 2, description: 'Standard offboarding process with NDA reminders' },
  ...
  },
  {
    ...
    options: [
      { label: 'Very Good', value: 3, description: 'Clear policies, technical enforcement, regular acknowledgment, consequences enforced' },
      { label: 'Good', value: 2, description: 'Documented policies with some technical controls' },
  ...
  // Physical Security Questions
  {
    ...
    options: [
      { label: 'Very Good', value: 3, description: 'Badge access with biometrics for sensitive areas, comprehensive audit trails' },
      { label: 'Good', value: 2, description: 'Badge access system with logging for all areas' },
  ...
  },
  {
    ...
    options: [
      { label: 'Very Good', value: 3, description: 'Pre-registration required, photo ID, escorted access, badge tracking' },
      { label: 'Good', value: 2, description: 'Sign-in required, visitor badges, escort for sensitive areas' },
  ...
  },
  {
    ...
    options: [
      { label: 'Very Good', value: 3, description: 'Comprehensive CCTV coverage, 90+ day retention, 24/7 monitoring' },
      { label: 'Good', value: 2, description: 'CCTV in key areas, adequate retention, regular review' },
  ...
  },
  {
    ...
    options: [
      { label: 'Very Good', value: 3, description: 'Clean desk policy enforced, secure storage, cross-cut shredding, media destruction' },
      { label: 'Good', value: 2, description: 'Clean desk policy, locked storage available' },
  ...
  },
  {
    ...
    options: [
      { label: 'Very Good', value: 3, description: 'Biometric access, mantraps, environmental monitoring, 24/7 security' },
      { label: 'Good', value: 2, description: 'Restricted access, environmental controls, logging' },
